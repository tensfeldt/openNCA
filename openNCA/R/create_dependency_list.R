...
create_dependency_list <- function() {
    ...
    dependency_list[["AET"]] <- list(callfun=c("aet"), regex="^(AET|AE(.[0-9]+?.[0-9]+?))$", unit_class=c(uclass_amount), valid_models=c(m4), display_list_models=c(m4sd, m4ss), predecessors=c())
    dependency_list[["AETAUi"]] <- list(callfun=c("aetau"), regex="^AETAU(i{1}?|[0-9]+?)$", unit_class=c(uclass_amount), valid_models=c(m4), display_list_models=c(m4ss), predecessors=c("AET"))
    ...
    dependency_list[["AETPCT"]] <- list(callfun=c("aetpct"), regex="^(AETPCT|AEPCT(.[0-9]+?.[0-9]+?))$", unit_class=c(uclass_percent), valid_models=c(m4), display_list_models=c(m4sd, m4ss), predecessors=c("AET"))
    dependency_list[["AETPCTi"]] <- list(callfun=c("aetpct"), regex="^(AETPCT(i{1}?)|AEPCT(.[0-9]+?.[0-9]+?))$", unit_class=c(uclass_percent), valid_models=c(m4), display_list_models=c(m4sd, m4ss), predecessors=c("AET"))
    ...
    dependency_list[["AUCINFOCi"]] <- list(callfun=c("auc_inf_oc"), regex="^AUCINFOC(i{1}?|[0-9]+?)$", unit_class=c(uclass_auc), valid_models=c(m1ss, m2ss, m3ss), display_list_models=c(), predecessors=c("AUCINFOi", "C0", "KEL"))
    dependency_list[["AUCINFODNi"]] <- list(callfun=c("auc_dn"), regex="^AUCINFODN(i{1}?|[0-9]+?)$", unit_class=c(uclass_aucnorm), valid_models=c(m1ss, m2ss, m3ss), display_list_models=c(), predecessors=c("AUCINFOi"))
    ...
    dependency_list[["AUCINFPDNi"]] <- list(callfun=c("auc_dn"), regex="^AUCINFPDN(i{1}?|[0-9]+?)$", unit_class=c(uclass_aucnorm), valid_models=c(m1ss, m2ss, m3ss), display_list_models=c(), predecessors=c("AUCINFPi"))
    ...
    dependency_list[["AUCTAU"]] <- list(callfun=c("auc_all"), regex="^AUCTAU$", unit_class=c(uclass_auc), valid_models=c(m1ss, m2ss, m3ss), display_list_models=c(m1ss, m3ss), predecessors=c("TMAX", "TAUi", "TOLDi", "KEL"))
    dependency_list[["AUCTAUi"]] <- list(callfun=c("auc_all"), regex="^AUCTAU(i{1}?|[0-9]+?)$", unit_class=c(uclass_auc), valid_models=c(m1ss, m2ss, m3ss), display_list_models=c(m1ss, m3ss), predecessors=c("TMAX", "TAUi", "TOLDi", "KEL"))
...
### 2019-09-01/TGT/ CENDINFDN not currently defined in computation engine codebase
    ...
    dependency_list[["CLFTAUWi"]] <- list(callfun=c(), regex="^CLFTAUW(i{1}?|[0-9]+?)$", unit_class=c(uclass_clwnorm), valid_models=c(m1ss), display_list_models=c(), predecessors=c("CLFTAUi", "DOSEC", "TAUi", "TOLDi"))
    ...
    dependency_list[["CMAXC"]] <- list(callfun=c(), regex="^CMAXC$", unit_class=c(uclass_amtvol), valid_models=c(m2sd), display_list_models=c(), predecessors=c("CMAX", "TMAX"))
    dependency_list[["CMAXCi"]] <- list(callfun=c(), regex="^CMAXC(i{1}?|[0-9]+?)$", unit_class=c(uclass_amtvol), valid_models=c(m2ss), display_list_models=c(), predecessors=c("CMAXi", "TMAXi", "TAUi", "TOLDi"))
...
### 2019-09-01/TGT/ MIDPTLAST not currently defined in computation engine codebase
    ...
    dependency_list[["MIDPTLASTi"]] <- list(callfun=c(), regex="^MIDPTLAST(i{1}?|[0-9]+?)$", unit_class=c(uclass_time), valid_models=c(m4ss), display_list_models=c(), predecessors=c("TLASTi", "TAUi", "TOLDi"))
