...
create_dependency_list <- function() {
    ...
    dependency_list[["AUCT"]] <- list(callfun=c("auc_t1_t2"), regex="^AUC(i{1}?|[0-9]+?)$", unit_class=c(uclass_auc), valid_models=c(m1, m2, m3), display_list_models=c(), predecessors=c("TMAX"))
    dependency_list[["AUCT1_T2"]] <- list(callfun=c("auc_t1_t2"), regex="^AUC(i{1}?|[0-9]+?)_(i{1}?|[0-9]+?)$", unit_class=c(uclass_auc), valid_models=c(m1, m2, m3), display_list_models=c(), predecessors=c("TMAX", "AUCT"))
    ...
    dependency_list[["AURCT"]] <- list(callfun=c("auc_t1_t2"), regex="^AURC([0-9]+?)$", unit_class=c(uclass_aurc), valid_models=c(m4), display_list_models=c(), predecessors=c("TMAXRATE"))
    dependency_list[["AURCT1_T2"]] <- list(callfun=c("auc_t1_t2"), regex="^AURC([0-9]+?)_([0-9]+?)$", unit_class=c(uclass_aurc), valid_models=c(m4), display_list_models=c(), predecessors=c("TMAXRATE"))
