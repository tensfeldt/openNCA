...
create_dependency_list <- function() {
    ...
    dependency_list[["AURCLAST"]] <- list(callfun=c("auc_last"), regex="^AURCLAST$", unit_class=c(uclass_aurc), valid_models=c(m4), display_list_models=c(), predecessors=c("MIDPTLAST", "TMAXRATE"))
