...
create_dependency_list <- function() {
    ...
    dependency_list[["AUCT"]] <- list(callfun=c("auc_t1_t2"), regex="^AUCT$", unit_class=c(uclass_auc), valid_models=c(m1, m2, m3), display_list_models=c(), predecessors=c("TMAX"))
    dependency_list[["AUCT1_T2"]] <- list(callfun=c("auc_t1_t2"), regex="^AUCT1_T2$", unit_class=c(uclass_auc), valid_models=c(m1, m2, m3), display_list_models=c(), predecessors=c("TMAX", "AUCT"))
    ...
    dependency_list[["AURCT1_T2"]] <- list(callfun=c("auc_t1_t2"), regex="^AURCT1_T2$", unit_class=c(uclass_aurc), valid_models=c(m4), display_list_models=c(), predecessors=c("TMAXRATE"))
...
### 2019-09-01/TGT/ CENDINFDN not currently defined in computation engine codebase
    dependency_list[["CENDINFDN"]] <- list(callfun=c(), regex="^CENDINFDN$", unit_class=c(uclass_concnorm), valid_models=c(m3), display_list_models=c(), predecessors=c())
    ...
    dependency_list[["CLFO"]] <- list(callfun=c(), regex="^CLFO$", unit_class=c(uclass_cl), valid_models=c(m1sd), display_list_models=c(), predecessors=c("AUCINFO"))
    ...
    dependency_list[["CLFP"]] <- list(callfun=c(), regex="^CLFP$", unit_class=c(uclass_cl), valid_models=c(m1sd), display_list_models=c(m1sd), predecessors=c("AUCINFP"))
    ...
    dependency_list[["CLFTAUi"]] <- list(callfun=c(), regex="^CLFTAU(i{1}?|[0-9]+?)$", unit_class=c(uclass_cl), valid_models=c(m1ss), display_list_models=c(m1ss), predecessors=c("AUCTAUi", "TAUi", "TOLDi"))
    dependency_list[["CLFTAUWi"]] <- list(callfun=c(), regex="^CCLTAUW(i{1}?|[0-9]+?)$", unit_class=c(uclass_clwnorm), valid_models=c(m1ss), display_list_models=c(), predecessors=c("CLFTAUi", "TAUi", "TOLDi"))
    dependency_list[["CLO"]] <- list(callfun=c(), regex="^CLO$", unit_class=c(uclass_cl), valid_models=c(m2sd, m3sd), display_list_models=c(), predecessors=c("AUCINFO"))
    ...
    dependency_list[["CLP"]] <- list(callfun=c(), regex="^CLP$", unit_class=c(uclass_cl), valid_models=c(m2sd, m3sd), display_list_models=c(m2sd, m3sd), predecessors=c("AUCINFP"))
    ...
    dependency_list[["CLTAUi"]] <- list(callfun=c(), regex="^CLTAU(i{1}?|[0-9]+?)$", unit_class=c(uclass_cl), valid_models=c(m2sd, m3sd), display_list_models=c(m3ss), predecessors=c("TAUi", "TOLDi"))
    dependency_list[["CLTAUWi"]] <- list(callfun=c(), regex="^CLTAUW(i{1}?|[0-9]+?)$", unit_class=c(uclass_clwnorm), valid_models=c(m2sd, m3sd), display_list_models=c(), predecessors=c("TAUi", "TOLDi"))
...
### 2019-09-01/TGT/ DOSEC not currently defined in computation engine codebase
    dependency_list[["DOSEC"]] <- list(callfun=c(), regex="^DOSEC$", unit_class=c(uclass_dose), valid_models=c(m1, m2, m3, m4), display_list_models=c(), predecessors=c())
...
### 2019-09-01/TGT/ MIDPTLAST not currently defined in computation engine codebase
    ...
    dependency_list[["MRTEVIFO"]] <- list(callfun=c(), regex="^MRTEVIFO$", unit_class=c(uclass_time), valid_models=c(m1), display_list_models=c(), predecessors=c("AUCINFO", "AUCTAU", "AUMCTAU", "TAUi", "TOLDi"))
    dependency_list[["MRTEVIFOi"]] <- list(callfun=c(), regex="^MRTEVIFO(i{1}?|[0-9]+?)$", unit_class=c(uclass_time), valid_models=c(m1), display_list_models=c(), predecessors=c("AUCINFOi", "AUCTAUi", "AUMCTAUi", "TAUi", "TOLDi"))
    dependency_list[["MRTEVIFP"]] <- list(callfun=c(), regex="^MRTEVIFP$", unit_class=c(uclass_time), valid_models=c(m1), display_list_models=c(), predecessors=c("AUCINFP", "AUCTAU", "AUMCTAU", "TAUi", "TOLDi"))
    dependency_list[["MRTEVIFPi"]] <- list(callfun=c(), regex="^MRTEVIFP(i{1}?|[0-9]+?)$", unit_class=c(uclass_time), valid_models=c(m1), display_list_models=c(), predecessors=c("AUCINFPi", "AUCTAUi", "AUMCTAUi", "TAUi", "TOLDi"))
    dependency_list[["MRTIVIFO"]] <- list(callfun=c(), regex="^MRTIVIFO$", unit_class=c(uclass_time), valid_models=c(m2, m3), display_list_models=c(), predecessors=c("TAU", "TOLD"))
    dependency_list[["MRTIVIFOi"]] <- list(callfun=c(), regex="^MRTIVIFO(i{1}?|[0-9]+?)$", unit_class=c(uclass_time), valid_models=c(m2, m3), display_list_models=c(), predecessors=c("TAUi", "TOLDi"))
    dependency_list[["MRTIVIFP"]] <- list(callfun=c(), regex="^MRTIVIFP$", unit_class=c(uclass_time), valid_models=c(m2, m3), display_list_models=c(m3sd, m3ss), predecessors=c("TAU", "TOLD"))
    dependency_list[["MRTIVIFPi"]] <- list(callfun=c(), regex="^MRTIVIFP(i{1}?|[0-9]+?)$", unit_class=c(uclass_time), valid_models=c(m2, m3), display_list_models=c(m3sd, m3ss), predecessors=c("TAUi", "TOLDi"))
...
### 2019-09-01/TGT/ PTROUGHRi not currently defined in computation engine codebase
    dependency_list[["PTROUGHRi"]] <- list(callfun=c(), regex="^PTROUGHR(i{1}?|[0-9]+?)$", unit_class=c(uclass_ratio), valid_models=c(m1ss, m2ss, m3ss), display_list_models=c(), predecessors=c("TAUi", "TOLDi"))
### 2019-09-01/TGT/ PTROUGHRENDi not currently defined in computation engine codebase
    dependency_list[["PTROUGHRENDi"]] <- list(callfun=c(), regex="^PTROUGHREND(i{1}?|[0-9]+?)$", unit_class=c(uclass_ratio), valid_models=c(m1ss, m2ss, m3ss), display_list_models=c(), predecessors=c("TAUi", "TOLDi"))
...
### 2019-09-01/TGT/ VSSPi not currently defined in computation engine codebase
    dependency_list[["VSSPi"]] <- list(callfun=c("vss"), regex="^VSSP(i{1}?|[0-9]+?)$", unit_class=c(uclass_volume), valid_models=c(m2ss, m3ss), display_list_models=c(m3ss), predecessors=c("CLP", "MRTIVIFPi", "TAUi", "TOLDi"))
...
### 2019-09-01/TGT/ VSSOi not currently defined in computation engine codebase
    dependency_list[["VSSOi"]] <- list(callfun=c("vss"), regex="^VSSO(i{1}?|[0-9]+?)$", unit_class=c(uclass_volume), valid_models=c(m2ss, m3ss), display_list_models=c(), predecessors=c("CLO", "MRTIVIFOi", "TAUi", "TOLDi"))
    ...
    dependency_list[["VZFO"]] <- list(callfun=c(), regex="^VZFO$", unit_class=c(uclass_volume), valid_models=c(m1sd), display_list_models=c(), predecessors=c("KEL", "AUCINFO"))
    ...
    dependency_list[["VZFP"]] <- list(callfun=c(), regex="^VZFP$", unit_class=c(uclass_volume), valid_models=c(m1sd), display_list_models=c(m1sd, m1ss), predecessors=c("KEL", "AUCINFP"))
    ...
    dependency_list[["VZFTAUi"]] <- list(callfun=c(), regex="^VZFTAU(i{1}?|[0-9]+?)$", unit_class=c(uclass_volume), valid_models=c(m1ss), display_list_models=c(), predecessors=c("KEL", "AUCTAUi", "TAUi", "TOLDi"))
    ...
    dependency_list[["VZO"]] <- list(callfun=c(), regex="^VZO$", unit_class=c(uclass_volume), valid_models=c(m2, m3), display_list_models=c(), predecessors=c("KEL", "AUCINFO"))
    ...
    dependency_list[["VZP"]] <- list(callfun=c(), regex="^VZP$", unit_class=c(uclass_volume), valid_models=c(m2, m3), display_list_models=c(m2sd, m3sd), predecessors=c("KEL", "AUCINFOP"))
...
### 2019-09-01/TGT/ VZTAUi not currently defined in computation engine codebase
    dependency_list[["VZTAUi"]] <- list(callfun=c(), regex="^VZTAU(i{1}?|[0-9]+?)$", unit_class=c(uclass_volume), valid_models=c(m2ss, m3ss), display_list_models=c(), predecessors=c("KEL", "AUCTAUi", "TAUi", "TOLDi"))
