...
create_dependency_list <- function() {
    ...
    dependency_list[["AE"]] <- list(callfun=c("ae"), regex="^AE$", unit_class=c(uclass_amount), valid_models=c(m4), display_list_models=c(m4sd, m4ss), predecessors=c())
    dependency_list[["AEPCT"]] <- list(callfun=c("aepct"), regex="^AEPCT$", unit_class=c(uclass_percent), valid_models=c(m4), display_list_models=c(m4sd, m4ss), predecessors=c("AE", "DOSEC"))
    dependency_list[["AEPCTi"]] <- list(callfun=c("aepct"), regex="^AEPCT(i{1}?|[0-9]+?)$", unit_class=c(uclass_percent), valid_models=c(m4), display_list_models=c(m4ss), predecessors=c("AE", "DOSEC", "DOSECi"))
    dependency_list[["AET"]] <- list(callfun=c("aet"), regex="^(AET|AE(.[0-9]+?.[0-9]+?))$", unit_class=c(uclass_amount), valid_models=c(m4), display_list_models=c(m4sd, m4ss), predecessors=c("DOSEC", "DOSECi"))
    dependency_list[["AETAUi"]] <- list(callfun=c("aetau"), regex="^AETAU(i{1}?|[0-9]+?)$", unit_class=c(uclass_amount), valid_models=c(m4), display_list_models=c(m4ss), predecessors=c("TOLDi", "TAUi", "AET"))
    dependency_list[["AETAUPTi"]] <- list(callfun=c("aetpct"), regex="^AETAUPT(i{1}?|[0-9]+?)$", unit_class=c(uclass_percent), valid_models=c(m4), display_list_models=c(m4ss), predecessors=c("AETAUi", "DOSECi"))
    dependency_list[["AETPCT"]] <- list(callfun=c("aetpct"), regex="^(AETPCT|AEPCT(.[0-9]+?.[0-9]+?))$", unit_class=c(uclass_percent), valid_models=c(m4), display_list_models=c(m4sd, m4ss), predecessors=c("AET", "DOSEC"))
    dependency_list[["AETPCTi"]] <- list(callfun=c("aetpct"), regex="^(AETPCT(i{1}?)|AEPCT(.[0-9]+?.[0-9]+?))$", unit_class=c(uclass_percent), valid_models=c(m4), display_list_models=c(m4sd, m4ss), predecessors=c("AET", "DOSECi", "DOSEC"))
    dependency_list[["AT"]] <- list(callfun=c("at"), regex="^(AT|AMT(.[0-9]+?.[0-9]+?)*?)$", unit_class=c(uclass_amount), valid_models=c(m4), display_list_models=c(m4sd, m4ss), predecessors=c())
    dependency_list[["AUCALL"]] <- list(callfun=c("auc_all"), regex="^AUCALL$", unit_class=c(uclass_auc), valid_models=c(m1, m2, m3), display_list_models=c(), predecessors=c("TMAX", "TMAXi"))
    dependency_list[["AUCALLDN"]] <- list(callfun=c("auc_dn"), regex="^AUCALLDN([0-9]*?)$", unit_class=c(uclass_aucnorm), valid_models=c(m1, m2, m3), display_list_models=c(), predecessors=c("AUCALL", "DOSEC", "DOSECi"))
    ...
    dependency_list[["AUCINFO"]] <- list(callfun=c("auc_inf_o"), regex="^AUCINFO$", unit_class=c(uclass_auc), valid_models=c(m1, m2, m3), display_list_models=c(), predecessors=c("CLAST", "AUCLAST", "KEL", "SPANRATIO", "CLASTi", "AUCLASTi"))
    ...
    dependency_list[["AUCINFODN"]] <- list(callfun=c("auc_dn"), regex="^AUCINFODN$", unit_class=c(uclass_aucnorm), valid_models=c(m1, m2, m3), display_list_models=c(), predecessors=c("AUCINFO", "DOSEC"))
    ...
    dependency_list[["AUCINFP"]] <- list(callfun=c("auc_inf_p"), regex="^AUCINFP$", unit_class=c(uclass_auc), valid_models=c(m1, m2, m3), display_list_models=c(m1sd, m2sd, m3sd), predecessors=c("TLAST", "CEST", "KEL", "KELC0", "AUCLAST", "SPANRATIO", "TLASTi", "AUCLASTi"))
    ...
    dependency_list[["AUCINFPDN"]] <- list(callfun=c("auc_dn"), regex="^AUCINFPDN$", unit_class=c(uclass_aucnorm), valid_models=c(m1, m2, m3), display_list_models=c(), predecessors=c("AUCINFP", "DOSEC"))
    ...
    dependency_list[["AUCLAST"]] <- list(callfun=c("auc_last"), regex="^AUCLAST$", unit_class=c(uclass_auc), valid_models=c(m1, m2, m3), display_list_models=c(m1sd, m2sd, m3sd), predecessors=c("TLAST", "TMAX", "TLASTi", "TMAXi"))
    ...
    dependency_list[["AUCLASTDN"]] <- list(callfun=c("auc_dn"), regex="^AUCLASTDN$", unit_class=c(uclass_aucnorm), valid_models=c(m1, m2, m3), display_list_models=c(), predecessors=c("AUCLAST", "DOSEC"))
    ...
    dependency_list[["AUCT"]] <- list(callfun=c("auc_t1_t2"), regex="^AUC(T|[0-9]+?)$", unit_class=c(uclass_auc), valid_models=c(m1, m2, m3), display_list_models=c(), predecessors=c("TMAX", "TMAXi", "DOSEC", "DOSECi"))
    ...
    dependency_list[["AUCTDN"]] <- list(callfun=c("auc_dn"), regex="^AUC(T|[0-9]+?)DN$", unit_class=c(uclass_aucnorm), valid_models=c(m1, m2, m3), display_list_models=c(), predecessors=c("AUCT", "DOSEC", "DOSECi"))
    ...
    dependency_list[["AUMCINFO"]] <- list(callfun=c(), regex="^AUMCINFO$", unit_class=c(uclass_aumc), valid_models=c(m1, m2, m3), display_list_models=c(), predecessors=c("AUMCLAST", "CLAST", "TLAST", "KEL"))
    ...
    dependency_list[["AUMCINFP"]] <- list(callfun=c(), regex="^AUMCINFP$", unit_class=c(uclass_aumc), valid_models=c(m1, m2, m3), display_list_models=c(), predecessors=c("CEST", "TLAST", "AUMCLAST", "KEL"))
    ...
    dependency_list[["AURCALL"]] <- list(callfun=c("auc_all"), regex="^AURCALL$", unit_class=c(uclass_aurc), valid_models=c(m4), display_list_models=c(), predecessors=c("TMAXRATE"))
    dependency_list[["AURCINFO"]] <- list(callfun=c("auc_inf_o"), regex="^AURCINFO$", unit_class=c(uclass_aurc), valid_models=c(m4), display_list_models=c(), predecessors=c("AURCLAST", "RATELAST", "KEL"))
    dependency_list[["AURCINFP"]] <- list(callfun=c("auc_inf_p"), regex="^AURCINFP$", unit_class=c(uclass_aurc), valid_models=c(m4), display_list_models=c(), predecessors=c("AURCLAST", "MIDPTLAST", "KEL"))
    dependency_list[["AURCLAST"]] <- list(callfun=c("auc_last"), regex="^AURCLAST$", unit_class=c(uclass_aurc), valid_models=c(m4), display_list_models=c(), predecessors=c("MIDPTLAST", "TMAXRATE", "MIDPTLASTi", "TMAXRATEi"))
    ...
    dependency_list[["AURCXPCTO"]] <- list(callfun=c(), regex="^AURCXPCTO$", unit_class=c(uclass_percent), valid_models=c(m4), display_list_models=c(), predecessors=c("AURCINFO", "AURCLAST"))
    dependency_list[["AURCXPCTP"]] <- list(callfun=c(), regex="^AURCXPCTP$", unit_class=c(uclass_percent), valid_models=c(m4), display_list_models=c(), predecessors=c("AURCINFP", "AURCLAST"))
    ...
    dependency_list[["CENDINF"]] <- list(callfun=c(), regex="^CENDINF$", unit_class=c(uclass_amtvol), valid_models=c(m3), display_list_models=c(m3sd), predecessors=c("DOF", "CMAX"))
    dependency_list[["CENDINFi"]] <- list(callfun=c(), regex="^CENDINF(i{1}?|[0-9]+?)$", unit_class=c(uclass_amtvol), valid_models=c(m3), display_list_models=c(m3ss), predecessors=c("DOFi", "TAUi", "TOLDi", "CMAXi"))
    dependency_list[["CENDINFDN"]] <- list(callfun=c(), regex="^CENDINFDN$", unit_class=c(uclass_concnorm), valid_models=c(m3), display_list_models=c(), predecessors=c("CENDINF", "DOSEC"))
    dependency_list[["CENDINFDNi"]] <- list(callfun=c(), regex="^CENDINFDN(i{1}?|[0-9]+?)$", unit_class=c(uclass_concnorm), valid_models=c(m3), display_list_models=c(), predecessors=c("CENDINFi", "DOSECi"))
...
###    dependency_list[["CLRTAUi"]] <- list(callfun=c(), regex="^CLRTAU(i{1}?|[0-9]+?)$", unit_class=c(uclass_cl), valid_models=c(m4ss), display_list_models=c(), predecessors=c("AETAUi", "AUCTAUi"))
    ...
    dependency_list[["CMAXC"]] <- list(callfun=c(), regex="^CMAXC$", unit_class=c(uclass_amtvol), valid_models=c(m2sd), display_list_models=c(), predecessors=c("CMAX", "TMAX", "C0"))
    dependency_list[["CMAXCi"]] <- list(callfun=c(), regex="^CMAXC(i{1}?|[0-9]+?)$", unit_class=c(uclass_amtvol), valid_models=c(m2ss), display_list_models=c(), predecessors=c("CMAXi", "TMAXi", "C0", "TAUi", "TOLDi"))
    dependency_list[["CMAXDN"]] <- list(callfun=c(), regex="^CMAXDN$", unit_class=c(uclass_concnorm), valid_models=c(m1, m2, m3), display_list_models=c(), predecessors=c("CMAX", "DOSEC"))
    ...
    dependency_list[["CMINDN"]] <- list(callfun=c(), regex="^CMINDN$", unit_class=c(uclass_concnorm), valid_models=c(m1, m2, m3), display_list_models=c(), predecessors=c("CMIN", "DOSEC"))
    dependency_list[["CMINDNi"]] <- list(callfun=c(), regex="^CMINDN(i{1}?|[0-9]+?)$", unit_class=c(uclass_concnorm), valid_models=c(m1, m2, m3), display_list_models=c(), predecessors=c("CMINi", "DOSECi"))
    dependency_list[["CTOLDesti"]] <- list(callfun=c(), regex="^CTOLDest(i{1}?|[0-9]+?)$", unit_class=c(uclass_amtvol), valid_models=c(m1ss, m2ss, m3ss), display_list_models=c(), predecessors=c("TAUi", "TOLDi"))
...
###    dependency_list[["FTAUi"]] <- list(callfun=c(), regex="^FTAU(i{1}?|[0-9]+?)$", unit_class=c(uclass_ratio), valid_models=c(m1ss, m2ss, m3ss), display_list_models=c(), predecessors=c("AUCTAUi", "AUCINFPi", "AUCINFP", "TAUi", "TOLDi"))
    ...
    dependency_list[["KELC0"]] <- list(callfun=c(), regex="^KELC0$", unit_class=c(uclass_amtvol), valid_models=c(m1, m2, m3), display_list_models=c(), predecessors=c("KEL"))
    dependency_list[["KELNOPT"]] <- list(callfun=c(), regex="^KELNOPT$", unit_class=c(uclass_none), valid_models=c(m1, m2, m3), display_list_models=c(m1sd, m1ss, m2sd, m3sd, m3ss), predecessors=c("KEL"))
    dependency_list[["KELR"]] <- list(callfun=c(), regex="^KELR$", unit_class=c(uclass_none), valid_models=c(m1, m2, m3), display_list_models=c(), predecessors=c())
    dependency_list[["KELRSQ"]] <- list(callfun=c(), regex="^KELRSQ$", unit_class=c(uclass_none), valid_models=c(m1, m2, m3), display_list_models=c(m1sd, m1ss, m2sd, m3sd, m3ss), predecessors=c("KELR"))
    dependency_list[["KELRSQA"]] <- list(callfun=c(), regex="^KELRSQA$", unit_class=c(uclass_none), valid_models=c(m1, m2, m3), display_list_models=c(), predecessors=c("KELR"))
    dependency_list[["KELTMHI"]] <- list(callfun=c(), regex="^KELTMLO$", unit_class=c(uclass_time), valid_models=c(m1, m2, m3), display_list_models=c(m1sd, m1ss, m2sd, m3sd, m3ss), predecessors=c("KEL"))
    dependency_list[["KELTMLO"]] <- list(callfun=c(), regex="^KELTMHI$", unit_class=c(uclass_time), valid_models=c(m1, m2, m3), display_list_models=c(m1sd, m1ss, m2sd, m3sd, m3ss), predecessors=c("KEL"))
...
### 2019-09-01/TGT/ MIDPTA not currently defined in computation engine codebase
    dependency_list[["MIDPTA"]] <- list(callfun=c(), regex="^(MIDPT)([0-9]*?|A)$", unit_class=c(uclass_time), valid_models=c(m4), display_list_models=c(), predecessors=c())
### 2019-09-01/TGT/ MIDPTN not currently defined in computation engine codebase
    dependency_list[["MIDPTN"]] <- list(callfun=c(), regex="^(MIDPT)([0-9]*?|N)$", unit_class=c(uclass_time), valid_models=c(m4), display_list_models=c(), predecessors=c())
### 2019-09-01/TGT/ MIDPTLAST not currently defined in computation engine codebase
    dependency_list[["MIDPTLAST"]] <- list(callfun=c(), regex="^MIDPTLAST$", unit_class=c(uclass_time), valid_models=c(m4), display_list_models=c(), predecessors=c())
    ...
    dependency_list[["MRTEVIFOi"]] <- list(callfun=c(), regex="^MRTEVIFO(i{1}?|[0-9]+?)$", unit_class=c(uclass_time), valid_models=c(m1ss), display_list_models=c(), predecessors=c("AUCINFOi", "AUMCINFOi", "AUMCLASTi", "AUCTAUi", "AUMCTAUi", "TAUi", "TOLDi"))
    ...
    dependency_list[["MRTLAST"]] <- list(callfun=c(), regex="^MRTLAST$", unit_class=c(uclass_time), valid_models=c(m1, m2, m3), display_list_models=c(m3sd, m3ss), predecessors=c("AUCLAST", "AUMCLAST", "DOF"))
...
### 2019-09-01/TGT/ RATEAi not currently defined in computation engine codebase
    dependency_list[["RATEA"]] <- list(callfun=c(), regex="^(RATE)([0-9]*?|A)$", unit_class=c(uclass_rate), valid_models=c(m4), display_list_models=c(), predecessors=c())
    dependency_list[["RATEAi"]] <- list(callfun=c(), regex="^(RATE)([0-9]*?|A|i{1}?)$", unit_class=c(uclass_rate), valid_models=c(m4), display_list_models=c(), predecessors=c())
### 2019-09-01/TGT/ RATENi not currently defined in computation engine codebase
    dependency_list[["RATEN"]] <- list(callfun=c(), regex="^(RATE)([0-9]*?|N)$", unit_class=c(uclass_rate), valid_models=c(m4), display_list_models=c(), predecessors=c())
    dependency_list[["RATENi"]] <- list(callfun=c(), regex="^(RATE)([0-9]*?|N|i{1}?)$", unit_class=c(uclass_rate), valid_models=c(m4), display_list_models=c(), predecessors=c())
...
###    dependency_list[["RSSi"]] <- list(callfun=c(), regex="^RSS(i{1}?|[0-9]+?)$", unit_class=c(uclass_ratio), valid_models=c(m1ss, m2ss, m3ss), display_list_models=c(), predecessors=c("TAUi", "TOLDi"))
    ...
    dependency_list[["TENDINF"]] <- list(callfun=c(), regex="^TENDINF$", unit_class=c(uclass_time), valid_models=c(m3), display_list_models=c(), predecessors=c("TMAX", "DOF"))
...
### 2019-09-01/TGT/ TMAXRATE not currently defined in computation engine codebase
    ...
    dependency_list[["V0"]] <- list(callfun=c(), regex="^V0$", unit_class=c(uclass_volume), valid_models=c(m2), display_list_models=c(m2sd), predecessors=c("C0", "DOSEC", "DOSECi"))
    ...
    dependency_list[["FLGACCEPTTMAX"]] <- list(callfun=c(), regex="^FLGACCEPTTMAX$", unit_class=c(), valid_models=c(m1, m2, m3, m4), display_list_models=c(), predecessors=c("TMAX", "TMAXi", "DOSE", "DOSEi"))
