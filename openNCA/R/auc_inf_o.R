...
#' }
#' @export
auc_inf_o <- function(conc = NULL, time = NULL, method = 1, kelflag = NULL, aucflag = NULL, auclast = NULL, c_last = NULL, spanratio = NULL, kel = NULL, interpolate = NULL, model = NULL, dosing_type = NULL, told = NULL, orig_conc = NULL, orig_time = NULL){
