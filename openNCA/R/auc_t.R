#' Area under the concentration versus time cruve from time 0 to time T
#'
...
#' 
#' auc_t(conc = conc_vector, time = time_vector)
#' #Error in auc_t: 'time' is not a numeric vector
#' 
#' @author
#' \itemize{
...
#' }
#' @export
auc_t <- function(conc = NULL, time = NULL, method = 1){
