#' Area under the first moment cruve from time 0 to infinity (Observed)
#'
...
#'  \eqn{CLAST = Observed concentration at the time of the last mesurable (non-zero) plasma 
#'  concentrations} \cr
...
#' aumc_inf_o(mod)  
#' #Please specify for which subject you want to get the AUMC_INF_O for!
#' 
#' aumc_inf_o(mod, sid = "all") 
#' #  SID              AUC     METHOD
#' #   30 4.94993257703106 Linear-Log
#' #   31                1 Linear-Log
#' #   32 5.15416479501756 Linear-Log
#' 
#' aumc_inf_o(mod, sid = 32)  
#' #  SID              AUC     METHOD
#' #   32 5.15416479501756 Linear-Log
#' 
#' aumc_inf_o(mod, sid = 10)  
#' #Invaild subject ID! Subject ID not found in the data provided!
#' 
#' aumc_inf_o(mod, sid = 31, method = 5)
...
#' \figure{rudraya.png} 
#' @export
aumc_inf_o <- function(conc = NULL, time = NULL, method = 1){
