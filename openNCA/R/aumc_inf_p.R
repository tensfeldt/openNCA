#' Area under the first moment curve from time 0 to infinity (Predicted)
#'
...
#' \strong{Equation}
#' \enumerate{
#'  \item Calculate the estimated concentration (Cest) at the time of the last measurable
#'  concentration: \cr
#'  \tabular{rl}{
...
#' \strong{Value} \cr
#' \itemize{
#'  \item AUMCINFP: area under the curve
#' }
#'
#' @examples
#' ##########
...
#'
#' #aumc_inf_p()
#' #Error in aumc_inf_p: 'conc' and 'time' vectors are NULL
#'
#' conc_vector <- c(2.89, 2.49, 2.47, 2.38, 2.32, 2.28)
#' time_vector <- c(0, 1, 2, 3, 4, 5)
#'
#' aumc_inf_p(conc = conc_vector, time = time_vector)
#' #1624.534
#'
#' ############
#' ## Data 2 ##
...
#' }
#' @export
aumc_inf_p <- function(conc = NULL, time = NULL, method = 1, kelflag = NULL, aucflag = NULL, aumclast = NULL, t_last = NULL, spanratio = NULL, kel = NULL){
