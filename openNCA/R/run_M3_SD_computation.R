...
###    if("MRTIVIFO" %in% display_list){
    if(disp_required[["MRTIVIFO"]]){
      display_parameters <- c(display_parameters, "MRTIVIFO")
    }
###    if("MRTIVIFP" %in% display_list){
    if(disp_required[["MRTIVIFP"]]){
