...
#' }
#' @export
auc_last <- function(conc = NULL, time = NULL, method = 1, exflag = NULL, t_last = NULL, t_max = NULL, interpolate = NULL, model = NULL, dosing_type = NULL, told = NULL, orig_conc = NULL, orig_time = NULL){
