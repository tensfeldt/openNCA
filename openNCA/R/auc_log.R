...
#' 
#! @export
auc_log <- function(conc = NULL, time = NULL, exflag = NULL, interpolate = NULL, extrapolate = NULL, model = NULL, dosing_type = NULL, dosing_interval = NULL, told = NULL, prev_told = NULL, prev_tau = NULL, last_crit_factor = NULL, kel = NULL, orig_conc = NULL, orig_time = NULL, orgtime = NULL, includeNA = FALSE){
...
##
      est_tmp <- estimate_missing_concentration(conc = conc, time = time, interpolate = interpolate, extrapolate = extrapolate, auc_method = "LOG", model = model, dosing_type = dosing_type, dosing_interval = dosing_interval, told = told, prev_told = prev_told, prev_tau = prev_tau, last_crit_factor = last_crit_factor, kel = kel, orig_conc = orig_conc, orig_time = orig_time, orgtime = orgtime)
      conc <- est_tmp[[1]]
      tmp <- data.frame(time, conc)
    }
    if(!is.na(t_max)){
