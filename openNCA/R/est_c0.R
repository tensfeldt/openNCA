...
#'
#' @examples
#' time <- c(0.00,0.25,0.50,1.00,1.50,2.00,3.00,5.00,8.00,12.00,
#'           24.00,48.00,72.00,96.00,120.00,168.00,336.00,504.00)
#' conc <- c(0.0,125.0,122.0,126.0,127.0,130.0,136.0,118.0,99.0,85.4,
#'           63.2,36.2,23.5,17.4,11.5,0.0,0.0,0.0)
#' est_c0(conc=conc, time=time)
#' # warning: <est_c0.R>: Following 0/zero/NA valued concentration data 
#' #                      points were removed from regression:
#'
#' #   time conc
#' # 1     0    0
#' # 16  168    0
