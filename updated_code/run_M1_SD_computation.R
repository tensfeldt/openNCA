...
#### KEVIN FOLLOWING MUST BE DONE OUTSIDE THESE ROUTINES NOT INSIDE AT ALL
...
#### YOU SHOULD NOT NEED TO RE-VALIDATE the parameter names at this point TOO MUCH CODE HERE and it prevents flexibility
  
  col_names <- c("SDEID")
  if("CMAXi" %in% return_list) {
    col_names <- c(col_names, "CMAX")   ### THIS PREVENTS CMAX1, CMAX2, etc. HOW ARE YOU DEALING WITH DOSING INTERVALS?????
  }
